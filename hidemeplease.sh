...
echo -e "\e[1;31;42m######┃┏┓┃┃╋┃┻┫┃┃┃┃┻┫┏┫┗┫┻┫╋┗╋━┃┻┫##### \e[0m"
echo -e "\e[1;31;42m######┗┛┗┻┻━┻━┻┻━┻┻━┻┛┗━┻━┻━━┻━┻━┛##### \e[0m\n"
echo -e "\e[30;48;5;82m    Copyright \e[40;38;5;82m   krishealty \e[0m \n\n"
...
read mask
url_checker $mask
echo -e '\nType social engineering words:(like free-money, win-money, free-iphone)'
...
echo -e "\nGenerating HideMePlease Link...\n"
final=$mask@$shorter
echo -e "Here is the HideMePlease URL:\e[32m ${final} \e[0m\n"
exit
fi
echo -e "\nGenerating HideMePlease Link...\n"
